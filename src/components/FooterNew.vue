<template>
  <footer class="footer-section text-center text-white py-5 position-relative">
    <!-- Scroll to top button -->
    <div class="scroll-top-btn position-absolute start-50 translate-middle bg-white d-flex align-items-center justify-content-center"
         @click="scrollToTop">
      <i class="bi bi-chevron-up text-dark fs-5"></i>
    </div>

    <!-- Social icons -->
    <div class="d-flex justify-content-center gap-4 mb-3" style="padding-top: 30px;">
    ...
    <!-- Copyright -->
    <small class="text-light d-block mt-2">&copy; Copyright 2025 Farrel Ahmad</small>
  </footer>
</template>
