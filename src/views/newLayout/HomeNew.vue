    ...
    <section id="home"
        ...
        <div class="content d-flex flex-column justify-content-center align-items-center h-100">
            ...
            <p class="desc-text mx-auto mb-5 home-anim py-5">
                I am a graduate of Telkom University Surabaya, Software Engineering program.
                I have experience and expertise in developing applications using technologies such as Laravel, Vue.js,
                AdonisJS,
                and managing databases like PostgreSQL and MySQL. I excel in creating efficient and scalable web-based
                solutions.
            </p>

            <div class="d-flex gap-3 mt-3 home-anim">
                <button class="btn-view-more d-flex align-items-center gap-2 mb-5 home-anim"
                    @mouseenter="hoverIcon = true" @mouseleave="hoverIcon = false" @click="scrollToAbout">
                    View More
                    <iconify-icon icon="formkit:arrowdown" width="26" height="26" :class="{ 'rotated': hoverIcon }" />
                </button>

                <a href="https://discord.gg/ZWmGSYYHuP" target="_blank"
                    class="btn-discord d-flex align-items-center gap-2 mb-5 home-anim" @mouseenter="discordHover = true"
                    @mouseleave="discordHover = false">
                    My Forum
                    <iconify-icon icon="ic:baseline-discord" width="26" height="26"
        ...
        <div class="container pt-5">
            ...
            <div class="row align-items-start responsive-abt">
                ...
                <div class="col-lg-7 mb-5">
                    ...
                    <p>
                        Now, I focus on creating efficient and scalable web applications using modern technologies like
                        Vue, React, Node.js, and Laravel, always striving for clean code and great user experiences.
                    </p>
        ...
        <div class="container pt-5">
            ...
            <div class="row mb-5">
                <div class="col text-center">
                    <div class="btn-group">
                        <button type="button" class="btn journey-btn"
                            :class="selectedTab === 'career' ? 'btn-fill' : 'btn-outline'" @click="switchTab('career')">
                            Career
                        </button>
                        <button type="button" class="btn journey-btn"
            ...
            <div ref="timelineWrapper">
                <v-timeline v-if="selectedTab === 'education'" class="custom-timeline" side="start">
                    <v-timeline-item v-for="(edu, i) in education" :key="`edu-${i}`" dot-color="transparent"
                ...
                <v-timeline v-else class="custom-timeline" side="start">
                    <v-timeline-item v-for="(job, i) in career" :key="`career-${i}`" dot-color="transparent"
                        class="custom-timeline-item timeline-anim">
                        <template v-slot:icon>
...
export default {
    ...
    data() {
        return {
            hoverIcon: false,
            infoCards: ['✨ Pixel Perfect', '🚀 Performance First', '📱 Responsive Design', '🧼 Clean Code'],
            Saya,
            hoverDiscord: false,
            selectedTab: "career",
            education: [
            ...
            career: [
                {
                    ...
                    title: "Video Editor",
                    desc: "Menghasilkan konten video berkualitas tinggi untuk YouTube channel Turah Parthayana.",
                    color: "#ec4899",
                },
                {
                    year: "2023",
        ...
        animateHero() {
            gsap.timeline({ delay: 0.3 })
                .fromTo(".home-anim",
                    ...
                    { opacity: 1, y: 0, scale: 1, duration: 0.6, stagger: 0.25, ease: "power2.out", clearProps: "all" }
                );
        },
        switchTab(tab) {
...
#home {
    ...
    background: radial-gradient(circle at 30% 30%, rgba(168, 85, 247, 0.08), transparent),
        radial-gradient(circle at bottom right, rgba(100, 72, 255, 0.12), transparent),
        #0b0014;
    padding-top: 4rem;
    padding-left: 1.5rem;
    /* ~24px */
